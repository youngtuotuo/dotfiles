...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'playground', 'indent-blankline.nvim', 'nvim-lspconfig', 'nvim-treesitter', 'nvim-treesitter-textobjects', 'nvim-colorizer.lua', 'nvim-treesitter-context'}, { event = "BufEnter *" }, _G.packer_plugins)]]

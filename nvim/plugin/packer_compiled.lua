...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-treesitter-context', 'nvim-treesitter-textobjects', 'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter', 'playground'}, { event = "BufEnter *" }, _G.packer_plugins)]]

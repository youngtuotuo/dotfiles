...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'playground', 'nvim-treesitter-context', 'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]

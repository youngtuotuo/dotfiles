...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter-textobjects'}, { event = "BufEnter *" }, _G.packer_plugins)]]

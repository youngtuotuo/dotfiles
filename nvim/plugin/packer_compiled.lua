...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'playground', 'nvim-treesitter-context', 'nvim-treesitter', 'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter-textobjects'}, { event = "BufEnter *" }, _G.packer_plugins)]]

...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter', 'playground', 'nvim-colorizer.lua', 'nvim-treesitter-textobjects', 'indent-blankline.nvim', 'nvim-treesitter-context'}, { event = "BufEnter *" }, _G.packer_plugins)]]

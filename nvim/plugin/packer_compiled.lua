...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'playground', 'nvim-treesitter-textobjects', 'nvim-treesitter-context', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]

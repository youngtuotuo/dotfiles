...
_G.packer_plugins = {
  ...
  ["rust-tools.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/support/.local/share/nvim/site/pack/packer/opt/rust-tools.nvim",
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'nvim-treesitter-textobjects', 'nvim-lspconfig', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'nvim-treesitter'}, { event = "BufEnter *" }, _G.packer_plugins)]]

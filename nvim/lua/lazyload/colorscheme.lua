...
vim.api.nvim_set_hl(0, "DiffAdd", { fg = "NvimLightGreen", bg = transparent })
vim.api.nvim_set_hl(0, "DiffChange", { fg = "NvimLightYellow", bg = transparent })
vim.api.nvim_set_hl(0, "DiffDelete", { fg = "NvimLightRed", bg = transparent })

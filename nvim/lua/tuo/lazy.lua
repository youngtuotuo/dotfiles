...
local plugins = {
    ...
    'tpope/vim-fugitive', -- lazy load
    {
        ...
        keys = {
            {
                "<leader>t",
                "<cmd>lua require('term').toggle()<CR>",
                mode = {'n', 't'},
                default_opts
            }
        },
        ...
        event = 'BufRead',
        config = function() require('lazyload.gitsigns') end
    }, {
        'norcalli/nvim-colorizer.lua',
        event = 'BufRead',
        config = function() require('lazyload.colorizer') end
    }, {
        "luukvbaal/statuscol.nvim",
        event = 'BufRead',
        config = function() require('lazyload.statuscol') end
    }, {
        "folke/zen-mode.nvim",
        keys = {
            {
        ...
        config = function() require('lazyload.vim-sum') end
    }, {
        ...
        "folke/twilight.nvim",
        event = 'BufRead',
        config = function() require('lazyload.twilight') end
    }, {
        ...
        ft = {'tex'},
        keys = {
            {"<leader>vc", ":VimtexCompile<CR>", mode = {"n"}, default_opts}
        },
        ...
        event = 'BufRead',
        config = function() require('lazyload.nvim-lint') end
    }, {
        'williamboman/mason-lspconfig.nvim',
        ft = {
            "lua", "c", "cpp", "rust", "tex", "html", "python", "yaml", "go",
            "haskell", "xml"
        },
        dependencies = {
            {

...
local plugins = {
    ...
    },
    {
        ...
        tag = '0.1.2',
        keys = {
            { "<space>a", "<cmd>lua require('telescope.builtin').builtin()<CR>",                   mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>r", "<cmd>lua require('telescope.builtin').lsp_references()<CR>",            mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>e", "<cmd>lua require('telescope.builtin').find_files()<CR>",                mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>f", "<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>", mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>g", "<cmd>lua require('telescope.builtin').git_files()<CR>",                 mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>d", "<cmd>lua require('telescope.builtin').diagnostics()<CR>",               mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>l", "<cmd>lua require('telescope.builtin').live_grep()<CR>",                 mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>b", "<cmd>lua require('telescope.builtin').buffers()<CR>",                   mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>c", "<cmd>lua require('telescope.builtin').commands()<CR>",                  mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>h", "<cmd>lua require('telescope.builtin').help_tags()<CR>",                 mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>m", "<cmd>lua require('telescope.builtin').keymaps()<CR>",                   mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>v", "<cmd>lua require('telescope.builtin').lsp_document_symbols()<CR>",      mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>u", "<cmd>lua require('telescope').extensions.undo.undo()<CR>",              mode = { 'n' },
                                                                                                                   default_opts },
            { "<space>3", "<cmd>lua require('telescope').extensions.heading.heading()<CR>",        mode = { 'n' },
                                                                                                                   default_opts },
        },
        config = function()
    ...
    },
    {
        ...
        keys = {
            ...
            {"<M-1>", function() require('harpoon.ui').nav_file(1) end, mode="n"},
            {"<M-2>", function() require('harpoon.ui').nav_file(2) end, mode="n"},
            {"<M-3>", function() require('harpoon.ui').nav_file(3) end, mode="n"},
            {"<M-4>", function() require('harpoon.ui').nav_file(4) end, mode="n"},
        },
        config = function()
